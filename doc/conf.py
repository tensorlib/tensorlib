...
project = u'tensorlib'
copyright = u'2014 - 2016, tensorlib developers (BSD License)'
...
htmlhelp_basename = 'tensorlibdoc'
...
# [howto/manual]).
latex_documents = [('index', 'user_guide.tex', u'tensorlib user guide',
